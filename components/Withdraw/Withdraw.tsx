...
import { type ReadContractReturnType, getAccount, readContract, writeContract } from '@wagmi/core'
    ...
    const handleCreateSignature = async () => {
        ...
        // collecting data for creation of signature
            const createWithdrawSigData: CreateWithdrawSigData = {
                ...
                contractAddress: account.chainId === 5 ? contract.goerli : contract.mumbai,
